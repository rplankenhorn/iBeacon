...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    {
        // Initialization code
        self.name = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 135, 25)];
        [self.name setFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:15]];
        [self.name setTextColor:[UIColor blackColor]];
        [self.contentView addSubview:self.name];
        
        self.detail = [[UILabel alloc] initWithFrame:CGRectMake(150, 0, 65, 25)];
